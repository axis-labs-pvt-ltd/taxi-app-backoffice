...
interface DownloadWithDateRangeProps {
  showPopup: boolean;
  ...
  >;
  handleDownload: (startDate: string, endDate: string) => void;
  loading: boolean;
}

const DownloadWithDateRange: React.FC<DownloadWithDateRangeProps> = ({
  showPopup,
  setShowPopup,
  startDate,
  setStartDate,
  ...
  const applyCustomRange = () => {
    ...
    handleDownload(formattedStart, formattedEnd);
    setShowPopup(false);
  };
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <MdOutlineDownload color="white" size={20}/>
      </button>
